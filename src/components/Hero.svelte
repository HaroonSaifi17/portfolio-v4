...
>
  ...
  <div class="relative hidden lg:block">
    ...
    ></div>
    <div
      class="hero-deco-card w-full h-[600px] border-4 border-foreground bg-card relative z-10 flex items-end justify-end overflow-hidden"
    >
      <span
        class="hero-watermark text-[200px] font-black leading-none text-foreground/5 select-none -mb-12 -mr-2 tracking-tighter"
      >
        MH
      </span>
    </div>
