...
<div class="agent-context-container relative my-8 md:my-12 p-4 sm:p-8 rounded-2xl md:rounded-3xl bg-neutral-900 border border-neutral-800 shadow-2xl overflow-hidden font-sans w-full">
  ...
  <div class="relative flex flex-col items-center max-w-lg mx-auto">
    ...
    <div class="stack-item relative z-10 w-full md:w-2/3 mt-6">
      <div class="flex flex-col items-center justify-center p-6 rounded-2xl bg-gradient-to-br from-red-900/40 to-orange-900/40 border border-red-700/50 shadow-[0_0_30px_rgba(239,68,68,0.15)] backdrop-blur-sm">
